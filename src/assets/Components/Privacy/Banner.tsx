export default function Banner() {
  return (
    <>
      <div className="bg-[url('/footer_dot.svg')] py-18 border-b border-primary">
        <div className="text-center">
          <h2 className="text-primary font-mono ">
            Privacy Policy  for <span className="lg:block inline">Gates Mills Technologies LLC </span>
          </h2>
          <p className="font-secondary text-gray text-body">Last updated: July 24, 2024</p>
        </div>
      </div>

      <div className="privacy p-6 font-secondary text-gray lg:text-[24px] text-lg">
        <p className="mb-6">
        ...
        <p className="mb-6">Interpretation and Definitions</p>
        <p>Interpretation</p>
        <p>
        ...
        <ul className="list-disc pl-6">
          ...
          <li className="font-secondary">
            ...
            this Agreement) refers to Gates Mills Technologies LLC, 11755
            Darlington Avenue #7, Los Angeles, CA 90049.
          </li>
          <li className="font-secondary">
          ...
          <li className="font-secondary">Service refers to the Website.</li>
          <li className="font-secondary">
          ...
          <li className="font-secondary">
            Website refers to Gates Mills Technologies LLC, accessible from
            gatesmillstech.com
          </li>
          <li className="font-secondary">
        ...
        <p className="mb-6">Collecting and Using Your Personal Data</p>
        <p className="mb-6">Types of Data Collected</p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li className="font-secondary">Email address</li>
          <li className="font-secondary">First name and last name</li>
          <li className="font-secondary">Usage Data</li>
        </ul>
        <p className="mb-6">
          Usage Data is collected automatically when using the Service and may
          include IP address, browser type, pages visited, time spent and
          diagnostic data.
        </p>
        <p className="mb-6">Usage Data</p>
        <p className="mb-6">
        ...
        <p className="mb-6">Tracking Technologies and Cookies</p>
        <p className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-4">
          ...
          <li className="font-secondary mb-6">
        ...
        <ul className="list-disc pl-6 space-y-4">
          ...
          <li className="font-secondary mb-7">
        ...
        <p className="mb-6">Retention of Your Personal Data</p>
        <p>
        ...
        <p className="mb-6">Transfer of Your Personal Data</p>
        <p className="mb-6">
        ...
        <p className="mb-6">Delete Your Personal Data</p>
        <p className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li className="font-secondary">Comply with a legal obligation</li>
          <li className="font-secondary">
          ...
          <li className="font-secondary">Protect against legal liability</li>
        </ul>
        ...
        <p>
          ...
          <br />
          <a
            href="https://gatesmillstech.com/privacy-policy"
            className="text-primary underline"
          >
            https://gatesmillstech.com/privacy-policy
          </a>
        </p>
      </div>
    </>
